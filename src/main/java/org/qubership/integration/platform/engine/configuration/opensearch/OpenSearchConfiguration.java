...
public class OpenSearchConfiguration {
    ...
    public OpenSearchConfiguration(Environment environment, @Qualifier("jsonMapper") ObjectMapper jsonMapper, @Lazy OpenSearchClientSupplier openSearchClientSupplier) {
    ...
    @Async
    @EventListener
    public void initIndexes(ApplicationStartedEvent event) {
